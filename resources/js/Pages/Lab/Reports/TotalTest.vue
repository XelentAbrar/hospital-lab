<template>
    <Head title="Test Count" />
    <AppLayout title="Test Count">
      <div class="w-full mx-auto pt-6">
        <div class="bg-white shadow-sm rounded-lg">
          <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            ...
            >
              <h1 class="font-semibold text-3xl text-primary">Test Count</h1>
              <div class="mt-2 ml-auto sm:mt-0">
                <form
                @submit.prevent="report.get(route('lab.test-count'), report)"
              >
              ...
              <div class="ring-1 ring-gray-300">
                    ...
                    <tbody>
                      ...
                      <tr
                        ...
                        <td
                          class="whitespace-nowrap relative"
                        >
                          {{ formatNumber(report?.test_Count) }}
                        </td>  <td
                          class="whitespace-nowrap relative"
                        >
                    ...
                    <tfoot>
                      ...
                      >
                        ...
                        >
                        {{ formatNumber(sum(reports, 'test_Count', 'report')) }}
                        </td>
                        <td
                          class="whitespace-nowrap relative"
                        >
