<template>
    <Head title="Package Test Count" />
    <AppLayout title="Package Test Count">
      <div class="w-full mx-auto pt-6">
        <div class="bg-white shadow-sm rounded-lg">
          <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            ...
            >
              <h1 class="font-semibold text-3xl text-primary">Package Test Count</h1>
              <div class="mt-2 ml-auto sm:mt-0">
                <form
                @submit.prevent="report.get(route('lab.package-count'), report)"
              >
              ...
              <div class="ring-1 ring-gray-300">
                    ...
                    <tbody>
                      ...
                      <tr
                        ...
                        <td
                          class="whitespace-nowrap relative text-right"
                        >
                          {{ formatNumber(report?.package_count) }}
                        </td>  <td
                          class="whitespace-nowrap relative text-right"
                        >
                    ...
                    <tfoot>
                      <tr
                        class="divide-x divide-gray-300 bg-secondary text_white"
                      >
                        <td
                          class="whitespace-nowrap relative"
                          colspan="2"
                        ...
                        <td
                          class="whitespace-nowrap text-center relative"
                        >
                        {{ formatNumber(sum(reports, 'package_count', 'report')) }}
                        </td>
                        <td
                          class="whitespace-nowrap relative"
                        >
