...
<tfoot>
                      ...
                      >
                        ...
                        {{ formatNumber(sum(patient_tests, 'donor_fee', 'report')) }}
                         ...
                         <td
                          class="whitespace-nowrap font-bold relative border-t border-gray-300" v-if="hasDonationModule"
                        >
